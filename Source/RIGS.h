...
// Mac OS X doesn't know about debug log.

#ifdef _MACOSX_

#define NSDebugLog NSLog
#define class_get_meta_class(class) objc_getMetaClass(class->name)
...
// VERSION is defined in GNUMakefile
// Defined in the Init function a static string with the RIGS version
#ifdef VERSION
